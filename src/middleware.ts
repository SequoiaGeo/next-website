...
const BOT_PATTERN =
  /googlebot|bingbot|yandexbot|baiduspider|facebookexternalhit|twitterbot|linkedinbot|slackbot|whatsapp|pinterest|embedly|W3C_Validator|lighthouse|pagespeed/i;
