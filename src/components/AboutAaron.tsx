        ...
        <div className="mx-auto grid max-w-5xl gap-16 lg:grid-cols-[280px_1fr] lg:items-start">
          ...
          <div className="flex flex-col items-center lg:items-start gap-5">
            ...
            <div className="mt-6 flex flex-wrap gap-2 justify-center lg:justify-start">
              {["B General", "C-2", "C-20 HVAC", "C-36 Plumbing"].map((lic) => (
                <span
                  key={lic}
                  className="rounded-full bg-[#D8F3DC] px-3 py-1 text-xs font-semibold text-[#1B4332]"
                >
                  {lic}
                </span>
              ))}
          ...
          <div>
            ...
            <h2 className="text-4xl font-extrabold tracking-tight text-[#1a1a1a] sm:text-5xl leading-[1.08]">
              ...
              <span className="text-[#2D6A4F]">you see things differently.</span>
            </h2>
            ...
            {/* Pull quote */}
            <blockquote className="mt-8 rounded-xl bg-[#1B4332] px-7 py-6">
              <p className="text-base font-medium italic text-[#D8F3DC]/90 leading-relaxed">
                &ldquo;An agency sends you a leads report. An owner asks why revenue didn&rsquo;t move.&rdquo;
              </p>
              <footer className="mt-4 flex items-center gap-3">
                <div className="h-px flex-1 bg-white/10" />
                <span className="text-sm font-semibold text-[#52B788]">Aaron Husak, Founder</span>
              </footer>
            </blockquote>
          </div>
        </div>
