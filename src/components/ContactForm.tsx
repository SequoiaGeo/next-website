        ...
        <div className="mx-auto grid max-w-5xl gap-16 lg:grid-cols-2 lg:items-start">
          ...
          <div>
            ...
            <h2 className="text-4xl font-extrabold tracking-tight text-[#1a1a1a] sm:text-5xl leading-[1.08]">
              Find out where your{" "}
              <span className="text-[#2D6A4F]">revenue is leaking.</span>
            </h2>
            ...
            <div className="mt-8 divide-y divide-gray-100">
              {[
                ...
                <div key={item.label} className="flex items-start gap-4 py-4 first:pt-0">
                  <div className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#D8F3DC]">
                    <svg className="h-3 w-3 text-[#2D6A4F]" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
            ...
            <div className="mt-8 pt-8 border-t border-gray-100 space-y-3">
              <a
                href="tel:5595213122"
                className="flex items-center gap-3 text-sm font-medium text-[#2D6A4F] hover:text-[#1B4332] transition-colors"
              >
            ...
            {submitted ? (
              <div className="flex flex-col items-center justify-center py-12 text-center">
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#D8F3DC]">
                  <svg className="h-8 w-8 text-[#2D6A4F]" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                  </svg>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1.5 w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm text-[#1a1a1a] placeholder-gray-400 focus:border-[#52B788] focus:outline-none focus:ring-2 focus:ring-[#52B788]/20"
                ...
                <div className="flex items-start gap-3">
                  <input
                    ...
                    className="mt-0.5 h-4 w-4 rounded border-gray-300 text-[#2D6A4F] focus:ring-[#52B788]"
                  />
                ...
                <button
                  type="submit"
                  className="w-full rounded-lg bg-[#2D6A4F] px-6 py-4 text-base font-semibold text-white shadow-lg shadow-[#2D6A4F]/25 transition hover:bg-[#1B4332] hover:shadow-xl focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#2D6A4F]"
                >
