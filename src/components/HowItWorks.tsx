...
const steps = [
  ...
  },
  {
    ...
    description:
      "With <strong>clean data</strong> and a functioning pipeline, we scale. More budget to channels that produce <strong>profitable jobs</strong>. Less to channels that produce reports. Expansion into <strong>new service areas</strong> or markets when the numbers support it.",
    icon: (
      <svg aria-hidden="true" className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            {steps.map((step, index) => (
              <div key={step.month} className="flex gap-8 py-10 first:pt-0">
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-3 text-base leading-relaxed text-gray-600" dangerouslySetInnerHTML={{ __html: step.description }} />
                </div>
              </div>
            ))}
          </div>
