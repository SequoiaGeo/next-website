    ...
    <section className="border-b border-[#0D2318]/15 bg-[#f7f5ef] text-[#0D2318]">
      <div className="mx-auto max-w-7xl px-6 py-10 sm:py-12 lg:px-8">
        ...
        <div className="grid gap-9 lg:grid-cols-[1.1fr_1fr] lg:items-start lg:gap-14">
          <div>
            <h1 className="text-[clamp(2.25rem,9vw,3.5rem)] font-extrabold leading-[0.98] tracking-[-0.055em] sm:text-7xl lg:text-[4rem] xl:text-[4.5rem]">Get Recommended<br /><span className="font-serif font-normal italic text-[#1A5C3A]">by AI.</span></h1>
          ...
          <div className="mt-7 border-t border-[#0D2318]/20 pt-6">
