        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          <div className="rounded-2xl border border-[#3A9E6A]/20 bg-[#fafaf8] p-7 sm:p-8">
            ...
            <p className="text-lg font-bold text-[#1a1a1a]">
              What a $28,000-a-month ad budget was really buying
            </p>
            <p className="mt-2 text-sm leading-relaxed text-gray-500">
              A Central Valley home improvement company&rsquo;s dashboard was grading its own
              homework: inflated conversion values, budget optimizing toward junk. Honest
              measurement cut the spend to about $7,500 a month while real project inquiries
              kept arriving.
            </p>
            <Link
