...
const posts = [
  ...
  },
  {
    ...
    excerpt:
      "A contractor was paying three marketing vendors. Every monthly report showed strong performance, but the review found misconfigured conversion goals and no clear line to booked jobs.",
    date: "April 2026",
    readTime: "8 min read",
